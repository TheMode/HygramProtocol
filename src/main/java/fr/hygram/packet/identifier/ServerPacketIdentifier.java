...
public class ServerPacketIdentifier {
    ...
    public static final short APPLICATION_ASSET_LIST_PACKET = 0x12;

    // All missing assets data to update the client
    // Sent after APPLICATION_ASSET_REQUEST_PACKET
    public static final short APPLICATION_ASSET_DATA_PACKET = 0x13;

    public static final short APPLICATION_POSITION_CHANGE_PACKET = 0x14;
